...
def detect_one(model, orgimg, device):
    ...
    # Inference
    t0 = time.time()
    pred = model(img)[0] # [0]=1*~*16 [1]=list(3)
    t1 = time_synchronized()
    # print(t1-t0)
    # Apply NMS
    pred = non_max_suppression_face(pred, conf_thres, iou_thres)[0] # [0]=img0
...
if __name__ == '__main__':
    ...
    model_path='/home/xiancai/plate/yolov5_face_plate/Result/2022_03_31/best.pt'
    model = load_model(model_path, device)

    # input_path='/home/xiancai/DATA/PLATE_DATA/'
    input_path = '/data1/xiancai/PLATE_DATA/other/1/'
    ...
    for ind, i in enumerate(ls):
        ...
        det=detect_one(model,orgimg,device)
        t1 = time_synchronized()
        # 画图
