...
class dataset_base:
    ...
    def make_train_val(self,name='jv_clean_plate'):
        '''
        制作train.txt val.txt
        :return:
        c'''
        ...
        imgs_path = f'/data1/xiancai/PLATE_DATA/plate_double_generate/*'
        # output
...
class labelme(dataset_base):
    '''
    处理labelme格式打标数据，扣出车牌，用于识别数据集
    '''

    # glob_str='/data1/xiancai/PLATE_DATA/zhwei/jv_clean/*/*/*g'
    # plate = '/data1/xiancai/PLATE_DATA/zhwei/jv_clean_plate/'
    ...
    def make_plate(self, tag_adjust=True):
        ...
        for ind, i in enumerate(ls):
            ...
            # save
            save_name='_'.join(i.split('/')[-3:-1])+'_'+str(ind)+'_'+cont['shapes'][0]['label']+'.jpg'
            cv2.imwrite(self.plate+save_name,img)
            print(f'{ind}/{len(ls)}')
...
if __name__ == '__main__':
    ...
    dataset_base().make_train_val(name='plate_double_generate')