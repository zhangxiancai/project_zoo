...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, scale=0.375, num_classes=2):
        super().__init__()
        ...
        self.avg_pool1 = nn.AvgPool2d(kernel_size=(3, 3), stride=(3,3), ceil_mode=True)
        self.avg_pool2 = nn.AvgPool2d(kernel_size=(3, 3), stride=(1,1), ceil_mode=True)
