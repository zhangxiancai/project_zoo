...
class MultiPlateGenerator:
    def __init__(self, adr_plate_model, adr_font):
        ...
        # 预存车牌底板图片
        self.bg_imgs={}
        self.bg_imgs['yellow']=cv2.imread('/home/xiancai/plate/LPRNet_Pytorch/chinese_license_plate_generator/plate_model/yellow_140.PNG')
        self.bg_imgs['white']=cv2.imread('/home/xiancai/plate/LPRNet_Pytorch/chinese_license_plate_generator/plate_model/white_140.PNG')
        self.bg_imgs['green_truck'] = cv2.imread('/home/xiancai/plate/LPRNet_Pytorch/chinese_license_plate_generator/plate_model/green_truck_140.PNG')
    ...
    def generate_plate_special(self, plate_number, bg_color, is_double, enhance=False):
        ...
        number_xy = self.get_location_multi(plate_number, height)
        # img_plate_model = cv2.imread(os.path.join(self.adr_plate_model, '{}_{}.PNG'.format(bg_color, height)))
        img_plate_model = self.bg_imgs[bg_color]
        img_plate_model = cv2.resize(img_plate_model, (440 if len(plate_number) == 7 else 480, height))
