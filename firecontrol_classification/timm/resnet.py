...
from timm.helpers import build_model_with_cfg
from timm.layers import DropBlock2d, DropPath, AvgPool2dSame, BlurPool2d, create_attn, get_attn, create_classifier
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, cardinality=1, base_width=64,
        ...
        assert base_width == 32, 'BasicBlock does not support changing base width'
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=3, in_chans=3,
                 cardinality=1, base_width=32, stem_width=32, stem_type='', replace_stem_pool=False,
        ...
        inplanes = stem_width * 2 if deep_stem else 32
        if deep_stem:
