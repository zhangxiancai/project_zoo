...
def run(data=ROOT / 'data/coco128.yaml',  # 'dataset.yaml path'
    ...
    ch = model.yaml['ch'] if model.yaml.get('ch') else 3 # for gray
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '/home/xiancai/baby/yolov5/results/2022_05_27_blazeSingleGray/best.pt', help='model.pt path(s)')
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[192,320], help='image (h, w)')
